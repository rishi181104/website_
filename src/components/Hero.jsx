...
import heroImage from "../assets/hero_page1.jpg";
...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="hero-layout" style={{ position: "relative", zIndex: 1, width: "100%" }}>
        ...
        >
          <div className="hero-image-float">
            <img
              src={heroImage}
              alt="Yoga instructor performing a seated pose outdoors"
